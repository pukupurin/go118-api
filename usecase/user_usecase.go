...
type UserUsecase interface {
	...
	UpdateUser(ctx context.Context, ID int, reqData ReqCreateUpdateUser) error
...
func (u *userUsecase) UpdateUser(ctx context.Context, ID int, reqData ReqCreateUpdateUser) error {
